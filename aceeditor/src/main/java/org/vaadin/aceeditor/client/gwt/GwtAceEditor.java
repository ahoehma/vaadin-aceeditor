...
public class GwtAceEditor extends JavaScriptObject {
  ...
  private static final String getModeString(final String mode) {
    return "ace/mode/" + mode;
  }

  private static final String getThemeString(final String theme) {
   ...
   * @since 0.8.14.1
   */
  public final native void setPrintMarginColumn(int printMargin)/*-{
      this.renderer.setPrintMarginColumn(printMargin);
  }-*/;
