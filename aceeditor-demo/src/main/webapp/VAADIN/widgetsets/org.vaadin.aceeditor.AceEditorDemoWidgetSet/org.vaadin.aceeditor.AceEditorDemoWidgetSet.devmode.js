...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.org.vaadin.aceeditor.AceEditorDemoWidgetSet=");
    idx += (13 + "org.vaadin.aceeditor.AceEditorDemoWidgetSet".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=org.vaadin.aceeditor.AceEditorDemoWidgetSet-0.js
